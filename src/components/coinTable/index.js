            ...
            <div className="center">
                <table>
                    ...
                    <tbody>                            
                        ...
                        <tr>
                            <td>　</td>
                            <td className="blue"><p className="blue askBlack">{this.props.asks[9].qty}</p></td>
                            <td className="blue"><p className="blue">{this.props.asks[9].price}</p></td>
                        ...
                        {
                            this.props.asks.slice(0, 9).reverse().map((ask, idx)=>{
                                return (
                                    <tr key={idx}>
                                        <td>　</td>
