...
class BithumbData extends Component {
  ...
  callOrderBook = () => {
    axios
      .get(
        `https://api.bithumb.com/public/orderbook/${this.state.order_currency}`,
        {
          params: {
            count: 10,
          },
  ...
  callTicker = () => {
    axios
      .get(`https://api.bithumb.com/public/ticker/${this.state.order_currency}`)
  ...
  callTransaction = () => {
    axios
      .get(
        `https://api.bithumb.com/public/transaction_history/${this.state.order_currency}`,
        {
          params: {
            count: 10,
          },
